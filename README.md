...
> [!CAUTION]\
> **警告，新版本NTQQ暂时无法使用，由于开发者精力有限，已暂停维护，请使用 [install_llob](https://github.com/super1207/install_llob) 项目！**
...
> [!IMPORTANT]
> 本插件适合**LLOB与NoneBot同时运行在同一台机器上**的用户<br>
> 使用本插件**管理进程并开启自动登录**，即可做到**命令行`nb run`自动连接Bot**！
